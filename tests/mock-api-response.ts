import { QuizQuestion, FetchQuestionsResponse } from '../src/types';
...
export type MockQuestion = QuizQuestion & { answerPlainText: string , category: string };
export type GenerateRandomQuestions = () => Promise<FetchQuestionsResponse<Partial<MockQuestion>>>;

export const generateRandomQuestions: GenerateRandomQuestions = async () => {
  return Promise.resolve({
    questions: getRandom(questions, 5),
  });
}
